...
import CertificatereviewsController from './controllers/certificatereviews';
import CertificatesController from './controllers/certificates';
import CollentsController from './controllers/collents';
import CoursegradesController from './controllers/coursegrades';
...
import StudentcreditsController from './controllers/studentcredits';
...
app.use('/api/certificatereviews', CertificatereviewsController)
app.use('/api/certificates', CertificatesController)
app.use('/api/collents', CollentsController)
app.use('/api/coursegrades', CoursegradesController)
...
app.use('/api/studentcredits', StudentcreditsController)
