  ...
  
{
    ...
    entities: [Certificates, Collents, Courses, Likes, Permissions, Reply, Roles, StudyRecords, Users],
    logging: true,
	dateStrings: true
}
...
const DB = {
  Certificates, Collents, Courses, Likes, Permissions, Reply, Roles, StudyRecords, Users
}
