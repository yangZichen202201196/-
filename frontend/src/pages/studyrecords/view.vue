                            ...
                            <div >
                                <div class="mb-3 grid ">
                                    ...
                                    <div class="col-12 md:col-4">
                                        <div class="flex gap-2 align-items-center card shadow-none p-3 surface-100 ">
                                            <div class="">
                                                <div class="text-400 mb-1">{{ $t('courseId') }}</div>
                                                <div class="font-bold">
                                                    <Button class="p-button-text" icon="pi pi-eye" :label="$t('coursesDetail')" v-if="item.course_id" @click="app.openPageDialog({ page: 'courses/view', url: `/courses/view/${item.course_id}` , closeBtn: true })" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 md:col-4">
                                        <div class="flex gap-2 align-items-center card shadow-none p-3 surface-100 ">
                                            <div class="">
                                                <div class="text-400 mb-1">{{ $t('progress') }}</div>
                                                <div class="font-bold">
                                                    <!-- <ProgressBar size="17px" :value="$utils.toPercent(item.progress, 100)" color="accent" v-tooltip="{value: data.progress}">
                                                    {{  $utils.toPercent(item.progress, 100) + '%'}}
                                                    </ProgressBar> -->
                                                    <Knob :size="60" readonly v-model="item.progress" :min="0" :max="100" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 md:col-4">
                                        <div class="flex gap-2 align-items-center card shadow-none p-3 surface-100 ">
                                            <div class="">
                                                ...
                                                <div class="font-bold">{{$utils.humanDate( item.study_date )}}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 md:col-4">
