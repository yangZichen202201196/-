                            ...
                            <div >
                                <div class="mb-3 grid ">
                                    ...
                                    <div class="col-12 md:col-4">
                                        <div class="flex gap-2 align-items-center card shadow-none p-3 surface-100 ">
                                            <div class="">
                                                <div class="text-400 mb-1">{{ $t('certificateType') }}</div>
                                                <div class="font-bold">{{ item.certificate_type }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 md:col-4">
                                        <div class="flex gap-2 align-items-center card shadow-none p-3 surface-100 ">
                                            <div class="">
                                                <div class="text-400 mb-1">{{ $t('certificateName') }}</div>
                                                <div class="font-bold">{{ item.certificate_name }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 md:col-4">
                                    ...
                                    <div class="col-12 md:col-4">
                                        <div class="flex gap-2 align-items-center card shadow-none p-3 surface-100 ">
                                            <div class="">
                                                <div class="text-400 mb-1">{{ $t('awardDate') }}</div>
                                                <div class="font-bold">{{$utils.humanDate( item.award_date )}}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 md:col-4">
                                    ...
                                    <div class="col-12 md:col-4">
                                        <div class="flex gap-2 align-items-center card shadow-none p-3 surface-100 ">
                                            <div class="">
                                                ...
                                                <div class="font-bold">{{ item.tx_hash }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 md:col-4">
                                        <div class="flex gap-2 align-items-center card shadow-none p-3 surface-100 ">
                                            <div class="">
                                                <div class="text-400 mb-1">{{ $t('certificatePhoto') }}</div>
                                                <div class="font-bold">
                                                    <image-viewer image-size="medium" image-preview-size="" :src="item.certificate_photo" width="auto" height="auto" class="img-fluid" :num-display="1">
                                                    </image-viewer>
                                                </div>
                                            </div>
                                        </div>
