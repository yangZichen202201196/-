            ...
            <div class="container-fluid">
                <div class="grid justify-content-center">
                    <div  class="col-12 sm:col-6 md:col-3 comp-grid" >
                        ...
                        <div  class="col-sm-3 col-md-3 col-6 comp-grid" >
                            <div class="">
                                <div class="card my-3 p-3 surface-50">
                                    <CoursesLoginpagelistPage ref="coursesListPage"  :limit="2" :show-header="true" :show-breadcrumbs="true" :show-footer="true" :paginate="true" page-store-key="USERS_ACCOUNTVIEW-COURSES-LOGINPAGELIST" is-sub-page>
                                    </CoursesLoginpagelistPage>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script setup>
	...
	import CoursesLoginpagelistPage from "../courses/loginpagelist.vue";
